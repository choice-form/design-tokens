...
export const SectionOverviewRampsColor = memo(
  function SectionOverviewRampsColor() {
    return (
      <Section
        title="Color Scales"
        content={
          <>
            <p>
              Our color foundation consists of carefully crafted color scales
              that form the building blocks for all semantic colors. Each scale
              contains 10 shades ranging from 100 (lightest) to 950 (darkest),
              providing comprehensive coverage for various design needs.
            </p>
            <p>
              <b>Prefer semantic tokens when possible</b>
            </p>
            <p>
              These foundational colors can be used directly, but we recommend
              utilizing semantic color tokens (like fg-default) instead of
              specific scale values (like blue-500) to maintain consistency and
